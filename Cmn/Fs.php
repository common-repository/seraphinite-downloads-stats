...
class Fs
{
	...
	static function StreamOutFileContent( $fileName, $mimeType = Fs::MimeTypeDef, $bHeadOnly = false, $bufSize = Fs::BufSizeDef, $asAttachment = false )
	{
	...
	static function GetMimeContentType( $filename )
	{
		...
		$mimeType = (isset($mime_types[ strtolower( Gen::GetFileExt( $filename ) ) ])?$mime_types[ strtolower( Gen::GetFileExt( $filename ) ) ]:null);
		if( empty( $mimeType ) )
